...
@interface BubblePopCustomAlertOverlayWindow : UIWindow
{
}
...
@implementation  BubblePopCustomAlertOverlayWindow
...
@interface BubblePopCustomAlertViewLayoutController : UIViewController
{
}
@end

@implementation BubblePopCustomAlertViewLayoutController
...
@interface BubblePopCustomAlertViewController()
- (void)enteredBackground:(NSNotification *)notification;
@end

@implementation BubblePopCustomAlertViewController
...
- (void)show:(UIView*)starter alertType:(NSInteger)value{
	...
	if (!window || ![window isKindOfClass:[BubblePopCustomAlertOverlayWindow class]]) {
	
        BubblePopCustomAlertViewLayoutController* avc = [[[BubblePopCustomAlertViewLayoutController alloc] init] autorelease];
        ...
        BubblePopCustomAlertOverlayWindow* ow = [[BubblePopCustomAlertOverlayWindow alloc] initWithFrame: [UIScreen mainScreen].bounds];
        ow.alpha = 0.0;
...
//                         [self autorelease];
    ...
    if ([sender tag] == BubblePopCAVCButtonTagCancel) {
