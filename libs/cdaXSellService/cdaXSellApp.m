...
-(NSString*) iconImageFileNameForSize: (NSString const*) size {
    ...
    if( cachedIconFileName == nil ) {        
        ...
        cachedIconFileName = [self iconFileNameForAppWithKey:self.appKey andSize:size];
...
-(CGSize) iconDimensions: (NSString const*) size {
    ...
    CGFloat width  = [[icon objectForKey:@"width"] floatValue] / [UIScreen mainScreen].scale;
    CGFloat height = [[icon objectForKey:@"height"] floatValue] / [UIScreen mainScreen].scale;
